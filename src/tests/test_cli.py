...
class TestCLI:
    ...
    def test_run_command_dry_run(self, sample_excel_file: Path, sample_field_map: Path, temp_dir: Path):
    ...
    def test_fuzzy_threshold_option(self, sample_excel_file: Path, sample_field_map: Path, temp_dir: Path):
    ...
    def test_log_level_option(self, sample_excel_file: Path, sample_field_map: Path, temp_dir: Path):
