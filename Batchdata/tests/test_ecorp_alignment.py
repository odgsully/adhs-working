...
def create_new_format_ecorp():
    ...
    return pd.DataFrame({
        ...
        'OWNER_TYPE': ['BUSINESS'],
        'ECORP_SEARCH_NAME': ['Test LLC'],
        'ECORP_TYPE': ['Entity'],
        'ECORP_NAME_S': ['TEST LLC'],
        'ECORP_ENTITY_ID_S': ['L123456'],
        'ECORP_ENTITY_TYPE': ['LLC'],
        'ECORP_STATUS': ['Active'],
        'ECORP_FORMATION_DATE': ['01/01/2020'],
        'ECORP_BUSINESS_TYPE': ['Limited Liability Company'],
        'ECORP_STATE': ['AZ'],
